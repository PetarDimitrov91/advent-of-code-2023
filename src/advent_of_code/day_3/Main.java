...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        extractPartNums();
        System.out.printf("Sum from part 1 is: %d", sum);
    }
    ...
    private static void calc(int r, int c, StringBuilder crrNum) {
        ...
        //System.out.println("for num:" + crrNum + " index " + startRow + " + " + startCol);
    ...
    private static void calcRatio(int r, int c, StringBuilder crrNum) {
        //check only to right and to the bottom row;

        //check to right
        int rowLength = schematic[r].length;

        if (c + 2 < rowLength && schematic[r][c] == '*') {
            StringBuilder nextNum = new StringBuilder();
            for (int i = c + 1; i < rowLength; i++) {
                char n = schematic[r][i];
            ...
            if (!nextNum.isEmpty()) {
                int a = Integer.parseInt(crrNum.toString());
                int b = Integer.parseInt(nextNum.toString());
    ...
    private static String extractNextRatioNum(String direction, int startRow, int startColl) {
        return null;
    }
}
...
982317 64238 776744 294607 382250 827428 567288 181552 775934 395962 34325 113367 846824 368710
